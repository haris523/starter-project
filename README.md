...
You can use this template with this command: `npx react-native init project-name --template https://github.com/haris523/starter-project.git`. After creating the project, navigate to the project folder, run the command `npx husky install`.
